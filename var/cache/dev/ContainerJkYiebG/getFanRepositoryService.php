 ...
 */
class getFanRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FanRepository' shared autowired service.
     *
     * @return \App\Repository\FanRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FanRepository.php';

        return $container->privates['App\\Repository\\FanRepository'] = new \App\Repository\FanRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
