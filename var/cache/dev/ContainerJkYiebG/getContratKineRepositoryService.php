 ...
 */
class getContratKineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContratKineRepository' shared autowired service.
     *
     * @return \App\Repository\ContratKineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContratKineRepository.php';

        return $container->privates['App\\Repository\\ContratKineRepository'] = new \App\Repository\ContratKineRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
