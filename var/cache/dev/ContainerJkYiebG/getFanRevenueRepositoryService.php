 ...
 */
class getFanRevenueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FanRevenueRepository' shared autowired service.
     *
     * @return \App\Repository\FanRevenueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FanRevenueRepository.php';

        return $container->privates['App\\Repository\\FanRevenueRepository'] = new \App\Repository\FanRevenueRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
