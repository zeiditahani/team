 ...
 */
class getKineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\KineRepository' shared autowired service.
     *
     * @return \App\Repository\KineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'KineRepository.php';

        return $container->privates['App\\Repository\\KineRepository'] = new \App\Repository\KineRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
