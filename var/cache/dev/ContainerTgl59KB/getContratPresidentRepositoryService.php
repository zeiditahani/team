 ...
 */
class getContratPresidentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContratPresidentRepository' shared autowired service.
     *
     * @return \App\Repository\ContratPresidentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContratPresidentRepository.php';

        return $container->privates['App\\Repository\\ContratPresidentRepository'] = new \App\Repository\ContratPresidentRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
