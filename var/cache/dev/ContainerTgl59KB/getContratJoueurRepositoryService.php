 ...
 */
class getContratJoueurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContratJoueurRepository' shared autowired service.
     *
     * @return \App\Repository\ContratJoueurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContratJoueurRepository.php';

        return $container->privates['App\\Repository\\ContratJoueurRepository'] = new \App\Repository\ContratJoueurRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
