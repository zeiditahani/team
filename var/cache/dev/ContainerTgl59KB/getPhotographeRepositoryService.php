 ...
 */
class getPhotographeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PhotographeRepository' shared autowired service.
     *
     * @return \App\Repository\PhotographeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PhotographeRepository.php';

        return $container->privates['App\\Repository\\PhotographeRepository'] = new \App\Repository\PhotographeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
