 ...
 */
class getContratPhotographeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContratPhotographeRepository' shared autowired service.
     *
     * @return \App\Repository\ContratPhotographeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContratPhotographeRepository.php';

        return $container->privates['App\\Repository\\ContratPhotographeRepository'] = new \App\Repository\ContratPhotographeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
