 ...
 */
class getEntraineurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EntraineurRepository' shared autowired service.
     *
     * @return \App\Repository\EntraineurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EntraineurRepository.php';

        return $container->privates['App\\Repository\\EntraineurRepository'] = new \App\Repository\EntraineurRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
