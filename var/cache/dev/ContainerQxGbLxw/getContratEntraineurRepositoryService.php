 ...
 */
class getContratEntraineurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContratEntraineurRepository' shared autowired service.
     *
     * @return \App\Repository\ContratEntraineurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContratEntraineurRepository.php';

        return $container->privates['App\\Repository\\ContratEntraineurRepository'] = new \App\Repository\ContratEntraineurRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
