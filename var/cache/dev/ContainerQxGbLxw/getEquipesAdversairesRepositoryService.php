 ...
 */
class getEquipesAdversairesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EquipesAdversairesRepository' shared autowired service.
     *
     * @return \App\Repository\EquipesAdversairesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EquipesAdversairesRepository.php';

        return $container->privates['App\\Repository\\EquipesAdversairesRepository'] = new \App\Repository\EquipesAdversairesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
