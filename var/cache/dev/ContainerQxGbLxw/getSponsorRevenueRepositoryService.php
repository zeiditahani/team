 ...
 */
class getSponsorRevenueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SponsorRevenueRepository' shared autowired service.
     *
     * @return \App\Repository\SponsorRevenueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SponsorRevenueRepository.php';

        return $container->privates['App\\Repository\\SponsorRevenueRepository'] = new \App\Repository\SponsorRevenueRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
