 ...
 */
class getTalentDataBaseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TalentDataBaseRepository' shared autowired service.
     *
     * @return \App\Repository\TalentDataBaseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TalentDataBaseRepository.php';

        return $container->privates['App\\Repository\\TalentDataBaseRepository'] = new \App\Repository\TalentDataBaseRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
