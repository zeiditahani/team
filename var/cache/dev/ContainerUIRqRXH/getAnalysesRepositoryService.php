 ...
 */
class getAnalysesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AnalysesRepository' shared autowired service.
     *
     * @return \App\Repository\AnalysesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AnalysesRepository.php';

        return $container->privates['App\\Repository\\AnalysesRepository'] = new \App\Repository\AnalysesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
