 ...
 */
class getMedicalCostRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MedicalCostRepository' shared autowired service.
     *
     * @return \App\Repository\MedicalCostRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MedicalCostRepository.php';

        return $container->privates['App\\Repository\\MedicalCostRepository'] = new \App\Repository\MedicalCostRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
