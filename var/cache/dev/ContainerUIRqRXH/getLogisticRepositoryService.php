 ...
 */
class getLogisticRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LogisticRepository' shared autowired service.
     *
     * @return \App\Repository\LogisticRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LogisticRepository.php';

        return $container->privates['App\\Repository\\LogisticRepository'] = new \App\Repository\LogisticRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
