 ...
 */
final class Version20250309140552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE logistic (id INT NOT NULL, type VARCHAR(255) NOT NULL, depense DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE matchs (id INT NOT NULL, equipe_adverse_id INT NOT NULL, date DATE NOT NULL, terrain VARCHAR(255) NOT NULL, tactique VARCHAR(10) NOT NULL, PRIMARY KEY(id))');
