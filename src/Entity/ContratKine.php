...
use App\Repository\ContratKineRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ContratKineRepository::class)]
class ContratKine
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: Kine::class, inversedBy: 'contrats')]
    #[ORM\JoinColumn(nullable: false, onDelete: "CASCADE")]
    private ?Kine $kine = null;
    ...
    public function getKine(): ?Kine
    {
        return $this->kine;
    }

    public function setKine(?Kine $kine): self
    {
        $this->kine = $kine;
        return $this;
    }
